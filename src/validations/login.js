...
let usuario = body('usuario').notEmpty().withMessage('Usuario requerido').bail().isEmail().withMessage('Email no válido').bail()
...
let password = body('password').notEmpty().withMessage('Password requerida')
    .custom(async (value, { req }) => {
